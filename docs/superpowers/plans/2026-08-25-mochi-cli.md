...
**Spec:** `docs/superpowers/specs/2026-08-25-mochi-cli-design.md`
...
expect(loadRuntimeConfig({}).openapiUrl).toBe("https://openapi.gitbook.com/o/bpgVa93BfrzaqXzuggv8/spec/mochi-api.json");
```
